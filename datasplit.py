...
class DataSplit:
    ...
    def __init__(self, dataset, train_test_split, val_train_split, shuffle=False):
    ...
    def get_test_loader(self, batch_size=50, num_workers=0):
        self.test_loader = torch.utils.data.DataLoader(self.dataset, batch_size=batch_size, sampler=self.test_sampler,
                                                       shuffle=False, num_workers=num_workers)
